...
var (
	...
	InitBundle                       = newResourceMetadata("InitBundle", permissions.GlobalScope)
	...
	IntegrationHealth                = newResourceMetadata("IntegrationHealth", permissions.GlobalScope)
	...
	NetworkEntity                    = newResourceMetadata("NetworkEntity", permissions.NamespaceScope)
	...
	PermissionSet                    = newResourceMetadata("PermissionSet", permissions.GlobalScope)
	Pod                              = newResourceMetadata("Pod", permissions.NamespaceScope)
	...
	ProcessBaseline                  = newResourceMetadata("ProcessBaseline", permissions.NamespaceScope)
	ProcessBaselineResults           = newResourceMetadata("ProcessBaselineResults", permissions.NamespaceScope)
	ProcessWhitelist                 = newResourceMetadata("ProcessWhitelist", permissions.NamespaceScope)
	ReportConfiguration              = newResourceMetadata("ReportConfiguration", permissions.GlobalScope)
	Role                             = newResourceMetadata("Role", permissions.GlobalScope)
	Risk                             = newResourceMetadata("Risk", permissions.NamespaceScope)
	SimpleAccessScope                = newResourceMetadata("SimpleAccessScope", permissions.GlobalScope)
