...
- **Operator:** Disable Scanner deployment in SecuredCluster custom resource if Central exists in the same namespace and
  use existing Scanner instance.
- **Helm chart:** Disable Scanner deployment in SecuredCluster chart if Central exists in the same namespace and
  use existing Scanner instance.
