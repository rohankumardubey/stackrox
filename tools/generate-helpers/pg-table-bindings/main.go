...
//go:embed ns.go.tpl
var namespaceSAC string

//go:embed cl.go.tpl
var clusterSAC string

//go:embed global.go.tpl
var globalSAC string
...
func main() {
	...
	c.Flags().StringVar(&scopelevel, "scope-level", "global", "the scope level of the resource for ")
